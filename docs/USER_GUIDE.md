# User Guide — Booking a Seat with SafeSeat

## 1. Find a bus

Open the app. You'll see a list of buses with their route, type (Seater /
Sleeper / Seater+Sleeper), departure time, and fare. Tap a bus to open its
seat map.

## 2. Book a seat automatically (recommended)

1. Fill in your **name**, **phone number**, and **gender**.
...
## 4. Understanding the seat colours
...
Scroll to "Manage a booking" on the bus page, find your seat, tap
**Cancel**. The seat becomes free again (still keeping its reserved status,
if it had one).

## 6. What this app does *not* do

- No location tracking, no data shared with anyone else.
- The reserved-seat feature only uses the gender you provide at booking and
  the bus's configured number of reserved pairs — nothing more.
